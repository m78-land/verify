...
- [usage](#2-usage)
    - [Basic](#21-basic)
    - [Asynchronous verification & single verification](#22-asynchronous-verification--single-verification)
    - [Name Example](#23-name-example)
    - [Validator](#24-validator)
    - [Nested validation](#25-nested-validation)
    - [Customize prompt template](#26-customize-prompt-template)
    - [Function parameter validation](#27-function-parameter-validation)
- [API](#2-api)
    - [NamePath](#21-namepath)
    - [Verify](#22-verify)
    - [Schema](#23-schema)
    - [Validator](#24-validator)
    - [Meta](#25-meta)
    - [RejectMeta](#26-rejectmeta)
    - [Config](#27-config)
